...
export default class OldPeakChart extends Component {
  state = {
    dataSet: undefined
  }
  ...
  render() {
    ...
    if (this.state.dataSet === undefined) {
      ...
      let dataSeries1 = {
        ...
        name: 'male',
        showInLegend: true,
        toolTipContent: "<span style=\"color:#4F81BC \">{name}</span><br>Age: {x}<br>oldpeak: {y}"
      };
      let dataSeries2 = {
        type: "spline",
        name: 'female',
      ...
      const options = {
        ...
        title: {
          text: "OldPeak group by Age and Gender"
        },
        axisX: {
          tile: "age"
        },

...
export default class ThalDemo extends Component {
        ...
        for(let age = 30; age < 75; age += 1){
            ...
            for(var key in Obj){
                if(Obj[key].age === age && Obj[key].sex === 1){
                    switch(Obj[key].thal){
                        case 3: cnt_male[0] += 1;break;
                        case 6: cnt_male[1] += 1;break;
                        default: cnt_male[2] += 1;break;
                    }
                }
                if(Obj[key].age === age && Obj[key].sex === 0){
                    switch(Obj[key].thal){
                        case 3: cnt_female[0] += 1;break;
                        case 6: cnt_female[1] += 1;break;
